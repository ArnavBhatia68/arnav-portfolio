...
const categoryStyles: Record<Project["categxaory"], { tint: string; badge: string }> = {
  "Full-Stack": {
...
export default function ProjectCard({ project, onViewDetails }: Props) {
  ...
  const externalActions = [
    project.primaryAction
      ? { key: `${project.primaryAction.label}-${project.primaryAction.url}`, label: project.primaryAction.label, href: project.primaryAction.url }
      : null,
    project.githubUrl ? { key: `GitHub-${project.githubUrl}`, label: "GitHub", href: project.githubUrl } : null,
